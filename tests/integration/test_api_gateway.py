...
class TestApiGateway(TestCase):
    ...
    def setUp(self) -> None:
        ...
        here we use cloudformation API to find out what the SpuneApi URL is
        """
        ...
        api_outputs = [output for output in stack_outputs if output["OutputKey"] == "SpuneApi"]
        self.assertTrue(api_outputs, f"Cannot find output SpuneApi in stack {stack_name}")
